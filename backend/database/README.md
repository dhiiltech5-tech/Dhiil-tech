...
- **Features**: Creates all 14 tables, sets primary key auto-increment sequences, maps relationships, and inserts default roles, permissions, and admin user (`admin@onetap.com` / `admin123`).

## 2. `schema_mysql.sql` (MySQL / MariaDB)
- **Target**: MySQL, MariaDB, XAMPP, phpMyAdmin, MySQL Workbench.
- **Usage**: Import or execute in phpMyAdmin / MySQL Workbench. Creates `onetap_db` schema and seeds default data.
