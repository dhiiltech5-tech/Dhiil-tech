      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <motion.p 
            ...
            className="text-slate-300 font-normal max-w-2xl mx-auto"
          >
        ...
        <div className="hidden md:flex flex-wrap justify-center gap-8">
          {servicesList.map((service, index) => (
            <motion.div
              ...
              className="glass-card p-8 group hover:border-[#00E676]/50 transition-all w-full md:w-[calc(50%-16px)] lg:w-[calc(33.333%-22px)] max-w-sm"
            >
              <div className="w-16 h-16 rounded-2xl bg-[#00E676]/10 border border-[#00E676]/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                {renderIcon(service.icon)}
              </div>
              <h3 className="text-xl font-extrabold mb-4 text-white group-hover:text-[#00E676] transition-colors">
                {service.name || service.title}
              </h3>
              <p className="text-slate-300 text-sm mb-6 line-clamp-3 leading-relaxed font-normal">
                {service.desc || service.description}
              </p>
              <Link 
                to="/services" 
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#00E676] group-hover:text-white transition-colors"
              >
